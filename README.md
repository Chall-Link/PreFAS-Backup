...
### 大切なファイルが災害からの紛失しないようにするアイデア
この課題解決のために今回考案したファイル保護のアイデアはは次の通りです。
...
このアイデアにより、パスワードさえ自分で保管しておけば、遠隔地に保存しながらファイルの中身を他人に見られることもなく、大切なファイルを長期安全に分散保存し、災害による紛失リスクを限りなくゼロに近づける事が可能となります。
