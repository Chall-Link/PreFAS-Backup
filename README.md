...
#### **プログラムの安定性**  
**市販ソフトの問題**: 複雑な構造なのでPC環境によって非常に動作が重いなどの動作が不安定になるなどのリスクがあります  
...
ご意見・ご感想はGitHubリポジトリのIssues（[https://github.com/Chall-Link/PreFAS](https://github.com/Chall-Link/PreFAS)）にてお願いします。
